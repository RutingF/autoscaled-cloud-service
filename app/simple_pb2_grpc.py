...
class EchoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.echo = channel.unary_unary(
                ...
                response_deserializer=simple__pb2.MessageResponse.FromString,
...
def add_EchoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'echo': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=simple__pb2.MessageResponse.SerializeToString,
            ),
    }
...
class Echo(object):
    ...
    def echo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            simple__pb2.MessageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
